# ops-dashboard Project Status

_Last updated: 2026-03-30_

## Goal

Build a dashboard/workspace for historical backtest analysis that is split into clear modules:
...
## Detailed current decisions that must stay aligned with implementation
